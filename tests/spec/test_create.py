...
class TestSpecCreateError:
    """Tests for SpecCreateError exception class."""

    def test_spec_create_error_exists(self) -> None:
        """SpecCreateError exception class exists and is an Exception."""
        assert issubclass(SpecCreateError, Exception)

    def test_spec_create_error_with_message(self) -> None:
...
class TestSpecConfig:
    ...
    def test_spec_config_has_name_field(self) -> None:
    ...
    def test_spec_config_has_code_field(self) -> None:
    ...
    def test_spec_config_has_issue_type_field(self) -> None:
    ...
    def test_spec_config_has_created_field(self) -> None:
...
class TestCreateValidation:
    """Tests for spec name validation in create function."""

    def test_invalid_name_raises_spec_create_error(self, tmp_path: Path) -> None:
    ...
    def test_underscore_name_raises_spec_create_error(self, tmp_path: Path) -> None:
        """Underscore in name raises SpecCreateError."""
        with pytest.raises(SpecCreateError, match="Invalid spec name"):
            create("invalid_name", base_dir=tmp_path)

    def test_space_in_name_raises_spec_create_error(self, tmp_path: Path) -> None:
        """Space in name raises SpecCreateError."""
        with pytest.raises(SpecCreateError, match="Invalid spec name"):
            create("invalid name", base_dir=tmp_path)

    def test_empty_name_raises_spec_create_error(self, tmp_path: Path) -> None:
        """Empty name raises SpecCreateError."""
        with pytest.raises(SpecCreateError, match="Invalid spec name"):
            create("", base_dir=tmp_path)

    def test_invalid_issue_type_raises_spec_create_error(self, tmp_path: Path) -> None:
    ...
    def test_valid_issue_types_accepted(self, tmp_path: Path) -> None:
...
class TestCreateExistingSpec:
    """Tests for existing spec detection."""

    def test_existing_spec_raises_spec_create_error(self, tmp_path: Path) -> None:
...
class TestCreateCodeGeneration:
    """Tests for unique code generation."""

    def test_generates_code_from_name(self, tmp_path: Path) -> None:
...
class TestCreateDirectoryBootstrap:
    """Tests for directory bootstrapping."""

    def test_creates_specs_directory(self, tmp_path: Path) -> None:
        """Creates specs/ directory if it doesn't exist."""
        create("test-spec", base_dir=tmp_path, register=False)
        assert (tmp_path / "specs").is_dir()

    def test_creates_active_directory(self, tmp_path: Path) -> None:
        """Creates specs/active/ directory if it doesn't exist."""
        create("test-spec", base_dir=tmp_path, register=False)
        assert (tmp_path / "specs" / "active").is_dir()

    def test_creates_spec_directory(self, tmp_path: Path) -> None:
    ...
    def test_existing_specs_directory_preserved(self, tmp_path: Path) -> None:
...
class TestCreateSpecMd:
    """Tests for spec.md file creation."""
    ...
    def test_spec_md_has_frontmatter(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_frontmatter_has_code(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_frontmatter_has_issue_type(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_frontmatter_has_created_date(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_frontmatter_has_status_active(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_has_title(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_has_overview_section(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_has_context_section(self, tmp_path: Path) -> None:
    ...
    def test_spec_md_has_success_criteria_section(self, tmp_path: Path) -> None:
...
class TestCreateIndexRegistration:
    ...
    def test_register_true_adds_to_index(self, tmp_path: Path) -> None:
    ...
    def test_register_false_does_not_create_index(self, tmp_path: Path) -> None:
        """register=False does not create index.yaml if it doesn't exist."""
        create("test-spec", base_dir=tmp_path, register=False)
        index_file = tmp_path / "specs" / "index.yaml"
        assert not index_file.exists()

    def test_register_false_does_not_modify_existing_index(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_register_appends_to_existing_index(self, tmp_path: Path) -> None:
...
class TestCreateReturnValue:
    """Tests for create function return value."""

    def test_returns_spec_config(self, tmp_path: Path) -> None:
    ...
    def test_return_has_correct_name(self, tmp_path: Path) -> None:
    ...
    def test_return_has_correct_code(self, tmp_path: Path) -> None:
        """Returned SpecConfig has correct code."""
        result = create("focus-state-dispatch", base_dir=tmp_path, register=False)
        assert result.code == "FSD"

    def test_return_has_correct_issue_type(self, tmp_path: Path) -> None:
    ...
    def test_return_has_correct_created_date(self, tmp_path: Path) -> None:
        """Returned SpecConfig has correct created date."""
        result = create("test-spec", base_dir=tmp_path, register=False)
        assert result.created == date.today()

    def test_default_issue_type_is_feature(self, tmp_path: Path) -> None:
...
class TestCreateEdgeCases:
    """Tests for edge cases in spec creation."""

    def test_single_letter_spec_name(self, tmp_path: Path) -> None:
        """Single letter spec name works."""
        result = create("a", base_dir=tmp_path, register=False)
        assert result.name == "a"
        assert result.code == "A"

    def test_long_spec_name(self, tmp_path: Path) -> None:
    ...
    def test_spec_name_with_numbers(self, tmp_path: Path) -> None:
