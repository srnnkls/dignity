...
- [x] **Create templates package directory**
...
- [x] **Implement PackageLoader for Jinja2**
  - Files: `src/dignity/spec/templates/__init__.py`
...
- [x] **Create dependencies.md.j2 template**
  - Files: `src/dignity/spec/templates/dependencies.md.j2`
  - DAG structure, batch table
  - Completion: Renders correctly

- [x] **Create validation-checklist.md.j2 template**
...
- [x] **Update create.py to use templates**
...
- [x] **Update spec package docstrings**
