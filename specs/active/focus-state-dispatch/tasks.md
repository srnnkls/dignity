...
- [ ] **Add trigger groups to TriggerSpec**
...
- [ ] **Update dispatcher for AND/OR matching**
...
- [ ] **Update config loading for trigger groups**
...
- [ ] **Extend FilesChangedTrigger for capture groups**
...
- [ ] **Pass captures to action context**
  - Files: `src/dignity/hooks/dispatch/dispatcher.py`
...
- [ ] **Add SetStateAction and ClearStateAction types**
  - Files: `src/dignity/hooks/dispatch/types.py`
...
- [ ] **Add action execution in dispatcher**
  - Files: `src/dignity/hooks/dispatch/dispatcher.py`
...
- [ ] **Add value extraction for SetStateAction**
  - Files: `src/dignity/hooks/dispatch/dispatcher.py`
...
- [ ] **Add state interpolation to InjectContextAction**
